...
int tt_read(uint64_t zobrist, uint32_t *mv, int depth, int ply, int alpha, int beta)
{
...
void tt_write(uint64_t zobrist, uint32_t mv, int depth, int ply, int eval, int flag)
{
